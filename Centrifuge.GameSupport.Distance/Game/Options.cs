...
namespace Centrifuge.Distance.Game
{
    public static class Options
    {
        ...
        public static class General
        {
            ...
            {
                get => Game.IsSteamBuild_ ? Manager.WorkshopLevelAutoDownloading_ : default;
                set => Manager.WorkshopLevelAutoDownloading_ = Game.IsSteamBuild_ ? value : default;
            }
            public static bool WorkshopRatingPrivacyMode
            {
                get => Game.IsSteamBuild_ ? Manager.WorkshopRatingPrivacyMode_ : default;
                set => Manager.WorkshopRatingPrivacyMode_ = Game.IsSteamBuild_ ? value : default;
            }
        }
