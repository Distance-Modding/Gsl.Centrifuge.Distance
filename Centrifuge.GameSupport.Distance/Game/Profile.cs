namespace Centrifuge.Distance.Game
{
    public static class Profile
    {
        ...
        {
            public static bool Adventure => Progress ? Progress.HasCompletedAdventureMode_ : false;
            public static bool LostToEchoes => Progress ? Progress.HasCompletedLostToEchoes_ : false;
            public static bool Nexus => Progress ? Progress.HasCompletedNexus_ : false;
        }
    }
}
